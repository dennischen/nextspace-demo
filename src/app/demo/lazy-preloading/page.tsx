    ...
    return <main className={demoStyles.main}>
        <div className={demoStyles.vlayout} style={{ gap: 8 }}>
            ...
            <div className={demoStyles.hlayout} style={{ gap: 8 }}>
                <button className={demoStyles.button} disabled={panel === 'panel1'} onClick={() => onChangePanel('panel1')}>Panel1</button>
                <button className={demoStyles.button} disabled={panel === 'panel2'} onClick={() => onChangePanel('panel2')}>Panel2</button>
                <button className={demoStyles.button} disabled={panel === 'panel3'} onClick={() => onChangePanel('panel3')}>Panel3 (Progress and no flash)</button>
            </div>
