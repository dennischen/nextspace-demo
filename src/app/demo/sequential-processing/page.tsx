        ...
        <div className={demoStyles.vlayout} style={{ gap: 8 }}>
            ...
            <div className={demoStyles.vlayout} style={{ gap: 8 }}>
                <div className={demoStyles.hlayout} style={{ gap: 8 }}>
                    ...
                    <input id="procNumber" type="number" disabled={running} value={procNumber} onChange={onChangeProcNumber}></input>
                </div>
                <div className={demoStyles.hlayout} style={{ gap: 8 }}>
                    <span>{i18n.l('sequentialProcessing.maxTimeout')}</span>
                    <input id="maxTimeout" type="number" disabled={running} value={maxTimeout} onChange={onChangeMaxTimeout}></input>
                </div>
            ...
            <div className={demoStyles.hlayout} style={{ gap: 8 }}>
                <button id="clear" disabled={running} onClick={onClickClearLogs}>{i18n.l('action.clear')}</button>
                <button id="run" disabled={running} onClick={onClickRun}>{i18n.l('action.run')}</button>
            </div>
